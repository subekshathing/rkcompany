...
var addProductValidationSchema = _yup["default"].object({
  ...
  category: _yup["default"].string().trim().required("Category is required.").oneOf(["grocery", "electronics", "furniture", "electrical", "kitchen", "kids", "sports", "auto", "clothes", "shoes", "pharmaceuticals", "stationery", "cosmetics"]),
